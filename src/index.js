...
root.render(
  <React.StrictMode> {/** Prevenir erro, mensagens de erros mais amigaveis e também faz renderizações adicionais dos componentes. Só deve ser usado em tempo de desenvolvimento */}
    <App />
  </React.StrictMode>
);