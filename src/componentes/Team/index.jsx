    ...
    return (
        astrosFiltrados.length > 0 ? <section className="team" style={{ backgroundColor: backgroundColor }}> {/**2 chaves - 1 para incorporar js, e a 2 é sintaxe para objeto js */}
            ...
            <div className="astros">
                {astrosFiltrados.map(astro => <AstroCard key={astro.nome} nome={astro.nome} planeta={astro.planeta} imagem={astro.imagem} primaryColor={primaryColor} backgroundColor={backgroundColor} />)}
            </div>
        </section>
